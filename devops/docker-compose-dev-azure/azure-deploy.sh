...
resourcename="petshopdatamodel"  # lower case, only
resourcegroup="petshopdatamodel_rg"
...
# git clone https://github.com/apilogicserver/petshopdatamodel.git
# cd petshopdatamodel
...
az group create --name petshopdatamodel_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group petshopdatamodel_rg --sku S1 --is-linux
az container create --resource-group petshopdatamodel_rg --name petshopdatamodel --image apilogicserver/petshopdatamodel:latest --dns-name-label petshopdatamodel --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//petshopdatamodel.westus.azurecontainer.io:5656'
