...
@Component({
  selector: 'ProductSupply-home',
  templateUrl: './ProductSupply-home.component.html',
  styleUrls: ['./ProductSupply-home.component.scss']
})
export class ProductSupplyHomeComponent implements AfterViewInit {
