...
@Component({
  selector: 'PetService-home',
  templateUrl: './PetService-home.component.html',
  styleUrls: ['./PetService-home.component.scss']
})
export class PetServiceHomeComponent implements AfterViewInit {
